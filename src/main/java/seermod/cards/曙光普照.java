...
public class 曙光普照 extends BaseCard{
    public static final String ID = makeID("Let There Be Light");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new seermod.actions.曙光(p, freeToPlayOnce, upgraded, energyOnUse));
    }
