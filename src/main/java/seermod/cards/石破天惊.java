...
public class 石破天惊 extends BaseCard {
    public static final String ID = makeID("Breakthrough");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (p.hasPower(致命一击.POWER_ID)) {
            addToBot(new ApplyPowerAction(p, p, new StrengthPower(m, magicNumber), magicNumber));
        }
    }
