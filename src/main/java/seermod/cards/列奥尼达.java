...
import seermod.powers.旷古长眠;
import seermod.util.CardStats;

public class 列奥尼达 extends BaseCard{
    public static final String ID = makeID("Leonidas");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new 旷古长眠(p, p, magicNumber), magicNumber));
    }
