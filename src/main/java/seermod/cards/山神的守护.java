...
import seermod.powers.山神守护;
import seermod.util.CardStats;

public class 山神的守护 extends BaseCard{
    public static final String ID = makeID("Mountain God");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new 山神守护(p, p, magicNumber), magicNumber));
    }
