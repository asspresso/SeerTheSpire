...
public class 圣光莫妮卡 extends BaseCard{
    public static final String ID = makeID("San Monica");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new 自然之力(p, magicNumber), magicNumber));
    }
