...
import seermod.powers.轮回之狱;
import seermod.util.CardStats;


public class 神话轮回者 extends BaseCard{
    public static final String ID = makeID("Apocalypse");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new 轮回之狱(p, 1), 1));
    }
