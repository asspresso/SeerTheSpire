...
import seermod.actions.击涛;
import seermod.character.SEER;
import seermod.util.CardStats;

public class 千里击涛 extends BaseCard {
    public static final String ID = makeID("Charging Tide");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new 击涛(m, new DamageInfo(p, damage, damageTypeForTurn)));
    }
