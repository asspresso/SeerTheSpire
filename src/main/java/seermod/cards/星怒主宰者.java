...
import seermod.powers.星皇之赐;
import seermod.util.CardStats;

public class 星怒主宰者 extends BaseCard{
    public static final String ID = makeID("Universe Emperor");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new 星皇之赐(p, p, magicNumber), magicNumber));
    }
