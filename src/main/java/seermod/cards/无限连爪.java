...
public class 无限连爪 extends BaseCard {
    public static final String ID = makeID("Infinite Claw");
    ...
    public 无限连爪() {
        ...
        setDamage(1, 0); //Sets the card's damage and how much it changes when upgraded.
        setMagic(5, 2);
