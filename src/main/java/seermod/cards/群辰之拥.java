...
public class 群辰之拥 extends BaseCard {
    public static final String ID = makeID("Celestial Embrace");
    ...
    public 群辰之拥() {
        ...
        setDamage(7, 3); //Sets the card's damage and how much it changes when upgraded.
        setMagic(7, 3);
