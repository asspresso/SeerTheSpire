...
public class 信号塔模型 extends BaseRelic {
    private static final String NAME = "Signal Tower"; //The name will be used for determining the image file as well as the ID.
    ...
    public void atBattleStart() {
        ...
        addToBot(new ApplyPowerAction(p, p, new 谱尼封印(p, p, 6), 6));
