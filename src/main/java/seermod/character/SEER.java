...
import seermod.cards.元素;
import seermod.cards.圣光气;
import seermod.cards.打击;
import seermod.cards.防御;
import seermod.relics.精灵胶囊;

import java.util.ArrayList;
import java.util.List;

import static seermod.SeerMod.characterPath;
import static seermod.SeerMod.makeID;

public class SEER extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("赛尔"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass SEER;
        @SpireEnum(name = "SEER_GRAY_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "SEER_GRAY_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new SEER(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
...
//                new SpriterAnimation(characterPath("animation/default.scml"))); //Animation
    ...
    public List<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new CutscenePanel(characterPath("ending/EndingSlice_1.png"), "ATTACK_PIERCING_WAIL"));
        panels.add(new CutscenePanel(characterPath("ending/EndingSlice_2.png"), "ATTACK_MAGIC_BEAM_SHORT"));
        panels.add(new CutscenePanel(characterPath("ending/EndingSlice_3.png"), "BOSS_VICTORY_STINGER"));
        return panels;
    }
